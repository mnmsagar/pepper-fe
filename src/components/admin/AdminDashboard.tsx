...
const AdminDashboard: React.FC = () => {
  ...
  const { partners, members, transactions, redemptions, loading, error } = useData();
  ...
  const totalCoinsInCirculation = members.reduce((sum, m) => sum + m.coin_balance, 0);
      ...
      <div className="min-h-screen bg-neutral-50 dark:bg-dark-bg-primary transition-colors duration-200">
        ...
        <div className="flex items-center justify-center min-h-[60vh]">
          <div className="text-center">
            ...
            <p className="text-neutral-600 dark:text-dark-text-secondary">Loading dashboard data...</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="min-h-screen bg-neutral-50 dark:bg-dark-bg-primary transition-colors duration-200">
        ...
        <div className="flex items-center justify-center min-h-[60vh]">
          <div className="text-center">
            ...
            <h3 className="text-lg font-medium text-neutral-900 dark:text-dark-text-primary mb-2">Failed to load data</h3>
            <p className="text-neutral-600 dark:text-dark-text-secondary mb-4">{error}</p>
            <button 
          ...
          <Routes>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="bg-white dark:bg-dark-bg-secondary rounded-xl shadow-soft border border-neutral-200 dark:border-dark-border-primary p-4 sm:p-6 transition-colors duration-200">
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="text-lg font-semibold text-neutral-900 dark:text-dark-text-primary">Pending Approvals</h3>
                    ...
                    <div className="space-y-3">
                      {redemptions.filter(r => r.status === 'pending').map((redemption) => (
                        <div key={redemption.id} className="flex items-center justify-between p-3 bg-neutral-50 dark:bg-dark-bg-tertiary rounded-lg">
                          <div>
                            <p className="font-medium text-neutral-900 dark:text-dark-text-primary">Redemption Request</p>
                            <p className="text-sm text-neutral-600 dark:text-dark-text-secondary">{redemption.coins_cost} coins</p>
                          </div>
                      ...
                      {pendingRedemptions === 0 && (
                        <p className="text-neutral-500 dark:text-dark-text-tertiary text-center py-4">No pending approvals</p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="bg-white dark:bg-dark-bg-secondary rounded-xl shadow-soft border border-neutral-200 dark:border-dark-border-primary p-4 sm:p-6 transition-colors duration-200">
                    <h3 className="text-lg font-semibold text-neutral-900 dark:text-dark-text-primary mb-4">Top Performing Partners</h3>
                    <div className="space-y-3">
                      {partners
                        ...
                        <div key={partner.id} className="flex items-center justify-between p-3 bg-neutral-50 dark:bg-dark-bg-tertiary rounded-lg">
                          <div>
                            ...
                            <p className="text-sm text-neutral-600 dark:text-dark-text-secondary">{partner.total_coins_distributed} coins distributed</p>
                          </div>
                          <div className="text-right">
                            <p className="font-semibold text-primary-600 dark:text-primary-400">₹{partner.wallet_balance}</p>
                            <p className="text-sm text-neutral-500 dark:text-dark-text-tertiary">wallet balance</p>
                          </div>
                        </div>
                      ))}
                    </div>
            ...
            <Route path="/settings" element={
              <div className="bg-white dark:bg-dark-bg-secondary rounded-xl shadow-soft border border-neutral-200 dark:border-dark-border-primary p-6 transition-colors duration-200">
                <h3 className="text-lg font-semibold text-neutral-900 dark:text-dark-text-primary mb-4">Platform Settings</h3>

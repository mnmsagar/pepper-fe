...
// const Header: React.FC<HeaderProps> = ({ title, subtitle, onMenuToggle, showMenuButton = false }) => {
...
//   const availableRoles = user?.roles.filter(role => role.role !== activeRole) || [];
...
//             )}
//             <div>
//               <h1 className="text-lg sm:text-2xl font-bold text-neutral-900 dark:text-dark-text-primary truncate transition-colors duration-200">{title}</h1>
//               {subtitle && (
//                 <p className="text-xs sm:text-sm text-neutral-600 dark:text-dark-text-secondary mt-1 hidden sm:block transition-colors duration-200">{subtitle}</p>
//               )}
//             </div>
//           </div>
...
//                   >
//                     <span className="text-sm font-medium capitalize text-neutral-900 dark:text-dark-text-primary">{activeRole}</span>
...
//                   <p className="text-sm font-medium text-neutral-900 dark:text-dark-text-primary truncate max-w-32">{user?.name}</p>
//                   <p className="text-xs text-neutral-500 dark:text-dark-text-tertiary truncate max-w-32">{user?.email}</p>
//                 </div>
//               </div>
...
//                 <h3 className="text-lg font-semibold text-neutral-900 dark:text-dark-text-primary">Account</h3>
//                 <button
...
//                 </div>
//                 <div>
//                   <p className="font-medium text-neutral-900 dark:text-dark-text-primary">{user?.name}</p>
//                   <p className="text-sm text-neutral-500 dark:text-dark-text-secondary">{user?.email}</p>
//                   <p className="text-xs text-primary-600 dark:text-primary-400 capitalize font-medium">Current: {activeRole}</p>
//                 </div>
//               </div>

//               {/* Theme Toggle */}
//               <div className="mb-6">
//                 <h4 className="text-sm font-medium text-neutral-700 dark:text-dark-text-secondary mb-3">Theme</h4>
...
//               {user && user.roles.length > 1 && (
//                 <div className="mb-6">
//                   <h4 className="text-sm font-medium text-neutral-700 dark:text-dark-text-secondary mb-3">Switch Role</h4>
...
//                       >
//                         <span className="capitalize font-medium text-neutral-900 dark:text-dark-text-primary">{role.role}</span>
//                       </button>
//                     ))}
//                   </div>
//                 </div>
